                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          screenTitle: "ProfileBankPage - Tab Container".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.profilebankpageTabContainerScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "ProfileSalaryPage".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.profilesalarypageScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle:
                              "ProfileSalaryComponentsPage - Tab Container".tr,
                          onTapScreenTitle: () => onTapScreenTitle(AppRoutes
                              .profilesalarycomponentspageTabContainerScreen),
                        ),
                      ],
                    ),
                  ),
